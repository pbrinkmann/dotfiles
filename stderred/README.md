...
I just added this as is, instead of making it a subtree module.

This is an older version, but the newer ones introduced a dependecny on cmake
(which isn't installed by default on most machines), so I just kept this older
version, which works fine everywhere.
